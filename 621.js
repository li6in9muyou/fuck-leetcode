...
const SIX_SPAN_2_OUTS = [
  // n+1 ... n+6 hence 6-span (窗口内 6 个位置选 5 个)
  ["A", "3", "4", "5", "6"], // Outs: 2 (成A-5), 7 (此组较特殊，2是窗口内唯一洞，7是外延)
  ["2", "4", "5", "6", "7"], // Outs: 3 (成2-6), 8 (成4-8)
  ["2", "3", "4", "5", "7"], // Outs: 6 (成2-6), A1 (成A-5)
  ["3", "5", "6", "7", "8"], // Outs: 4 (成3-7), 9 (成5-9)
  ["3", "4", "5", "6", "8"], // Outs: 7 (成3-7), 2 (成2-6)
  ["4", "6", "7", "8", "9"], // Outs: 5 (成4-8), 10 (成6-10)
  ["4", "5", "6", "7", "9"], // Outs: 8 (成4-8), 3 (成3-7)
  ["5", "7", "8", "9", "10"], // Outs: 6 (成5-9), J (成7-J)
  ["5", "6", "7", "8", "10"], // Outs: 9 (成5-9), 4 (成4-8)
  ["6", "8", "9", "10", "J"], // Outs: 7 (成6-10), Q (成8-Q)
  ["6", "7", "8", "9", "J"], // Outs: 10 (成6-10), 5 (成5-9)
  ["7", "9", "10", "J", "Q"], // Outs: 8 (成7-J), K (成9-K)
  ["7", "8", "9", "10", "Q"], // Outs: J (成7-J), 6 (成6-10)
  ["8", "10", "J", "Q", "K"], // Outs: 9 (成8-Q), A14 (成10-A)
  ["8", "9", "10", "J", "K"], // Outs: Q (成8-Q), 7 (成7-J)
  ["9", "10", "J", "Q", "A"], // Outs: K (成10-A), 8 (成8-Q)
];
const SEVEN_SPAN_2_OUTS = [
  // n+1 ... n+7 hence 7-span
